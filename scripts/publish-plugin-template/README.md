...
> A launcher tab inside [Hermes Agent](https://github.com/NousResearch/hermes-agent)'s web dashboard for **[TokenTelemetry](https://tokenanalytics.app)** — local observability for **Hermes Agent AND 9 coding agents** (Claude Code, OpenAI Codex, Gemini CLI, Cursor, GitHub Copilot, Qwen, OpenCode, Vibe, Antigravity).

> ℹ️ This repo is **auto-generated** from the canonical source in [`2netgr/tokenanalytics`](https://github.com/2netgr/tokenanalytics). File issues and PRs upstream.
...
Or clone the repo: <https://github.com/2netgr/tokenanalytics>
...
- **TokenTelemetry homepage**: <https://tokenanalytics.app>
- **TokenTelemetry source**: <https://github.com/2netgr/tokenanalytics>
...
- 💬 **Discussions** (ideas, Q&A, show-and-tell): <https://github.com/2netgr/tokenanalytics/discussions>
- 🐛 **Issues** (bugs, concrete feature requests): <https://github.com/2netgr/tokenanalytics/issues>
