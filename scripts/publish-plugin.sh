...
#        gh repo create 2netgr/tokenanalytics-hermes-plugin \
#          --public --license MIT \
...
PUBLISH_REPO="${PUBLISH_REPO:-git@github.com:2netgr/tokenanalytics-hermes-plugin.git}"
NEW_VERSION="${1:-}"
...
echo "  Install: hermes plugins install 2netgr/tokenanalytics-hermes-plugin"
