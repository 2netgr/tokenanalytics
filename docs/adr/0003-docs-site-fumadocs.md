...
to GitHub Pages on `tokenanalytics.app`. It markets the product but doesn't teach
...
existing `website/` app, served from **GitHub Pages at `tokenanalytics.app/docs`
...
- **Subdomain `docs.tokenanalytics.app`** — rejected: search engines treat a
