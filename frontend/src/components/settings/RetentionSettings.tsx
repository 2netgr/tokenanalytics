  ...
  return (
    <div className="space-y-3">
      <p className="text-[12px] text-[var(--tt-fg-dim)] max-w-[640px]">
        ...
        analytics. TokenAnalytics always keeps a tiny <span className="text-[var(--tt-fg)]">core summary</span> of
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <div className="flex items-center gap-1.5" title={a.archivable ? "Keep full transcripts in TokenAnalytics" : "Archiving not available for this agent yet"}>
