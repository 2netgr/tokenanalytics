    ...
    <div className="px-8 py-8 max-w-[900px] mx-auto space-y-10 pb-20">
      ...
      >
        <div className="rounded-[var(--tt-radius-lg)] border border-[var(--tt-border)] bg-[var(--tt-sunken)] p-6 space-y-4 text-sm text-[var(--tt-fg-dim)]">
          <p>
            TokenAnalytics can automatically measure your machine&apos;s real power draw. Depending on your hardware and OS, this reads your GPU directly (e.g. nvidia-smi) or uses your system&apos;s battery discharge rate.
          </p>
          ...
          <p className="mt-4">
            TokenAnalytics will sample your power draw for 5 seconds and lock in the wattage. This ensures your local model costs are based on actual electricity usage rather than cloud API rates!
          </p>
        </div>
      </Section>
