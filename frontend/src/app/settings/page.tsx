...
import AgentVisibilitySettings from "@/components/settings/AgentVisibilitySettings";
  ...
  return (
    <div className="px-8 py-8 max-w-[900px] mx-auto space-y-10 pb-20">
      <PageHeader
        ...
        title="Settings"
        description="Configure how TokenAnalytics summarizes your session traces."
      ...
      <Section
        ...
        description="Keep sessions in sync across your machines. Point a secondary device at a hub to sync both ways, or expose this device as a hub for the others. Runs over your LAN or tailnet — nothing leaves your network."
      >
        <div id="multi-device-sync" className="scroll-mt-20">
          <MultiDeviceSyncSettings />
        </div>
      </Section>

      <Section
        title="Agent &amp; page visibility"
        description="Some agents and pages are hidden by default. Enable them here if you need them."
      >
