    ...
    <div className="px-8 py-8 max-w-[1600px] mx-auto space-y-10 pb-20">
      ...
      {!loading && hermesSessions.length === 0 && (
        <EmptyState
          ...
          description="Run Hermes Agent locally (state.db lives under $HERMES_HOME, or ~/.hermes by default) to see sessions appear here. TokenAnalytics scans every refresh."
        />
      )}
