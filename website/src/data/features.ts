...
export const FEATURES: Feature[] = [
  {
    ...
    bullets: [
      ...
      "Hermes Dashboard plugin: one-command install adds a TokenAnalytics tab inside Hermes's own web UI (port 9119) — deep-link launcher to Overview, Skills, Memory, Analytics, Projects.",
    ],
