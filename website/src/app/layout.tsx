...
const SITE_URL = "https://tokenanalytics.app";
const TITLE = "TokenAnalytics — Observability for coding & autonomous agents (Hermes, Claude Code, Codex …)";
const DESCRIPTION =
  "TokenAnalytics is local, read-only observability for 10 coding agents (Claude Code, Codex, Gemini CLI, Cursor, Copilot, Qwen, OpenCode, Vibe, Antigravity, Grok Build) plus Hermes Agent (Nous Research) — with a dedicated dashboard for gateway health, cron jobs, skills, memory, and 38 source platforms. One command, 100% on your machine.";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: TITLE,
  description: DESCRIPTION,
  applicationName: "TokenAnalytics",
  keywords: [
    "TokenAnalytics",
    "TokenTelemetry",
    "tokentelemetry",
...
const JSON_LD = {
  ...
  name: "TokenAnalytics",
  alternateName: ["TokenAnalytics", "tokentelemetry", "Token-Telemetry"],
  url: SITE_URL,
  sameAs: [
    "https://github.com/2netgr/tokenanalytics",
  ...
  codeRepository: "https://github.com/2netgr/tokenanalytics",
};
...
const ORG_LD = {
  ...
  "@type": "Organization",
  name: "TokenAnalytics",
  alternateName: ["TokenAnalytics", "tokentelemetry"],
  url: SITE_URL,
