...
export const metadata: Metadata = {
  title: "Privacy Policy — TokenAnalytics",
  description:
    "How TokenAnalytics handles privacy: your logs, prompts, and costs stay on your machine; the app sends only anonymous, content-free usage stats (on by default, one-click off).",
  alternates: { canonical: "https://tokenanalytics.app/privacy" },
  ...
  return (
    <main className="max-w-[760px] mx-auto px-5 sm:px-8 py-16 sm:py-24">
      ...
      <div className="mt-8 text-[15px] leading-relaxed text-[var(--tt-fg-muted)] space-y-3">
        <p>
          TokenAnalytics respects your privacy. As the product evolves, we need to understand how people
      ...
      <Section title="This website">
        <p>
          The marketing site (tokenanalytics.app) loads{" "}
      ...
      <Section title="Contact">
        <p>
          ...
          <a
            href="https://github.com/2netgr/tokenanalytics/issues"
            target="_blank"
