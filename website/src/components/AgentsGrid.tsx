 ...
 * card is a real button that expands to reveal what TokenAnalytics captures and
      ...
      <div className="max-w-[1180px] mx-auto px-5 py-12 sm:py-[72px]">
        <div className="text-center max-w-[680px] mx-auto mb-10">
          ...
          <p className="mt-3.5 text-[15.5px] text-[var(--tt-fg-muted)] leading-relaxed">
            Tap any agent to see what TokenAnalytics captures and where it reads from.
          </p>
        </div>
