        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-[15px] sm:text-[17px] text-[var(--tt-fg-muted)] leading-relaxed mb-6 max-w-xl">
              ...
              <strong className="text-[var(--tt-fg)]"> 38 source platforms in total</strong>. TokenAnalytics is the only tool that observes them as a single agent, with a dedicated dashboard that respects how Hermes actually works.
            </p>
