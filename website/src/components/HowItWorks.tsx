const STEPS = [
  {
    ...
    code: <><span className="text-[var(--tt-fg-faint)]">$ </span>curl -fsSL https://raw.githubusercontent.com/2netgr/tokenanalytics/main/install.sh | bash</>,
  },
  {
    n: "2",
    ...
    <section className="relative max-w-[1180px] mx-auto px-5 py-12 sm:py-[72px]">
      <div className="text-center max-w-[680px] mx-auto mb-10">
        ...
        <p className="mt-3.5 text-[15.5px] text-[var(--tt-fg-muted)] leading-relaxed">
          Your agents already write logs. TokenAnalytics just reads them — so setup is one line, and there&apos;s
