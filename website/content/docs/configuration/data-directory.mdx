...
description: Move TokenAnalytics's config and state to a different directory using --data-dir, TOKENTELEMETRY_DATA_DIR, or TOKENTELEMETRY_HOME.
---

By default, TokenAnalytics stores all its config and state in `~/.tokentelemetry/`. You can move this to any directory you like — useful for keeping your system drive clear, isolating tool state on a secondary drive, or running multiple independent instances.
